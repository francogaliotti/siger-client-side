...
export class TipoLicenciaInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: TipoLicenciaInterceptorService, multi: true }];

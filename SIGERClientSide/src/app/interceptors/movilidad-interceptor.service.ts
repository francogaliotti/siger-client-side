...
export class MovilidadInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: MovilidadInterceptorService, multi: true }];
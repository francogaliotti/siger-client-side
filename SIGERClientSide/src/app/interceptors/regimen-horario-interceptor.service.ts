...
export class RegimenHorarioInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: RegimenHorarioInterceptorService, multi: true }];
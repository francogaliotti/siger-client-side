...
export class RemuneracionInterceptorService {
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: RemuneracionInterceptorService, multi: true }];
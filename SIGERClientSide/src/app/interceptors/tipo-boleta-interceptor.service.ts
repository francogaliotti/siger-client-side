...
export class TipoBoletaInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: TipoBoletaInterceptorService, multi: true }];
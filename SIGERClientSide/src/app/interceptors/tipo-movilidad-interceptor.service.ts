...
export class TipoMovilidadInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: TipoMovilidadInterceptorService, multi: true }];

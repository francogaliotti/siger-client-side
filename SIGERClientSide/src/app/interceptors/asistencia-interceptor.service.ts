...
export class AsistenciaInterceptorService implements HttpInterceptor{
...
export const interceptorProvider = [{ provide: HTTP_INTERCEPTORS, useClass: AsistenciaInterceptorService, multi: true }];